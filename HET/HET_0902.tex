...
to the latitude of installation was applied \cite{?}. % TODO: Add reference
...
\Cref{fig:transmission-lcoe} reveals that the \gls{lcoe} is generally
...
\Cref{fig:optLayouts} confirms that the cost of transmission increases with increasing
...
% %
% % A European \gls{vres} layout is determined by the vectors
...
% $x_{1} = \gamma_{1}, ..., x_{N} =\gamma_{N}, x_{N+1} = \alpha_{1}, ...,
% x_{2N} = \alpha_{N}$.
% The optimization objective is global minimization of the \gls{lcoe} as a
% function of $\boldsymbol x$. The \gls{lcoe} is a complicated function of the
...
% as defined in (\ref{eq:stdev}). A geographical dispersion of \gls{vres}
